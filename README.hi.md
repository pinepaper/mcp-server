...
सर्वर **157 टूल** देता है — ड्रॉइंग, एनिमेशन, डायग्राम, नक्शे, टाइपोग्राफ़ी, फिज़िक्स, इमेज एडिटिंग, डेटा विज़ुअलाइज़ेशन और एक्सपोर्ट:
...
**लोकल मुफ़्त और पूरा है।** अगर आप यह सर्वर खुद चलाते हैं तो सारे टूल काम करते
हैं। कोई सीमित संस्करण नहीं है।

ज़रूरत: Node 18 या नया, लगभग **320 MB** डिस्क (Puppeteer क्रोम डाउनलोड करता है)
और जॉब चलने के दौरान करीब 1 GB मेमोरी। लैपटॉप पर यह ठीक है; छोटे VPS या
प्रतिबंधित ऑफ़िस मशीन पर मुश्किल।

**[cloud.pinepaper.studio](https://cloud.pinepaper.studio) वही सर्वर आपके लिए
चलाता है** — वही टूल, वही वर्ज़न, HTTP पर, बिना इंस्टॉल और बिना ब्राउज़र के।

होस्टिंग पर खर्च होता है, इसलिए यह सशुल्क है — यह क्रेडिट पर चलता है। मौजूदा
मूल्य के लिए [cloud.pinepaper.studio](https://cloud.pinepaper.studio) देखें। हो सके तो
लोकल चलाएँ, लेकिन यह एक जैसा नहीं है: होस्टेड सेवा परखे हुए LLM चलाती है और
जनरेट किए गए कोड को कैनवास तक पहुँचने से पहले ठीक करती है — यह लोकल सर्वर
अपने आप नहीं कर सकता। कौन-सा मॉडल बेहतर है, यह आप खुद जाँच सकते हैं: एक बेंचमार्क एक ही प्रॉम्प्ट
कई मॉडलों पर चलाकर नतीजे साथ-साथ दिखाता है, और कोई भी रन साझा किया जा सकता है।
यह फ़िलहाल केवल आमंत्रण-आधारित बीटा में है।
