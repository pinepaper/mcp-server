...
export const ENGINE_FACADES: Readonly<Record<string, readonly string[]>> = Object.freeze({
  ...
  generatorRegistry: Object.freeze(['_cachedCanvasCenter', '_capabilities', '_cleanupInteractiveListeners', '_clearGeneratorCallbacks', '_drainGeneratorState', '_elementSeq', '_generatorNeedsReExecution', '_mergeWithDefaults', '_normalizeRegion', '_pools', '_raiseNonGeneratorItems', '_refitTimer', '_registerA3Generators', '_registerBuiltinGenerators', '_removeGeneratorRegionGroup', '_removePatternClipMask', 'acceleration', 'activeGenerator', 'addBoundaryVertices', 'addPoint', 'animationCallback', 'app', 'attachMotion', 'clear', 'color', 'count', 'createPool', 'currentParams', 'describeMotions', 'execute', 'executeAsync', 'finishEdges', 'generatedElements', 'generators', 'get', 'getAll', 'getByCategory', 'getElement', 'getElementsByRole', 'getPresets', 'group', 'head', 'index', 'maxForce', 'maxSpeed', 'position', 'rebuildFromState', 'register', 'registerElement', 'setAnimationCallback', 'setCapabilities', 'tail', 'tailPositions', 'unregister', 'update', 'updateElement', 'updateParam', 'velocity']),
