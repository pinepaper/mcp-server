      ...
      properties: {
        ...
        pdf: {
          ...
          properties: {
            ...
            searchableText: { type: 'boolean', description: 'Default true where the studio supports it: an invisible text layer over the artwork, so the PDF is selectable, searchable and screen-readable. Latin script only (Arabic, Hebrew, CJK lines are drawn but left out, and fidelity says how many). Multi-page (pages) exports get it per page on studios that support it. false omits it. result.pdf reports linesWritten / linesSkipped.' },
