...
export const PP_VOCABULARY: PinePaperVocabulary = {
  ...
  types: {
    ...
    'pp:Stitchcraft':     { anchor: 'schema:VisualArtwork', description: "Procedural embroidery: an item rendered in thread — satin and long-and-short fills, stem outlines, seeded fills — following a direction field, with optional hand wobble. The engine's mark-maker is applyThreadPainting; there is no cross-stitch or running-seam stitch in it, and 'seed' and 'stem' are the nearest marks.", parentType: 'pp:CanvasElement', createdWith: 'pp:CanvasShape', mcpTool: 'pinepaper_design_medium' },
