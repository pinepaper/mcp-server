...
**`pinepaper_world3d` gains the mesh half and the import half — 24 actions.** The graph learned to record `meshProvenance` above, and nothing could author a mesh: it could describe a thing the tool surface could not make.
