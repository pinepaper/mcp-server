...
**139개의 툴** 제공 — 드로잉, 애니메이션, 다이어그램, 지도, 타이포그래피, 물리, 이미지 편집, 데이터 시각화, 내보내기:
...
호스팅에는 비용이 들기 때문에 유료입니다: **Starter 월 $4.99**
(하루 500회), **Pro 월 $14.99** (하루 5,000회, 애니메이션 템플릿 라이브러리
포함). 로컬에서 실행할 수 있다면 로컬로 실행하세요 — 잃는 것은 없습니다.
