...
**140 個のツール**を提供 — 描画・アニメーション・図・地図・タイポグラフィ・物理・画像編集・データ可視化・エクスポート：
...
ホスティングには費用がかかるため有料です: **Starter 月額 $4.99**
(1 日 500 リクエスト)、**Pro 月額 $14.99** (1 日 5,000、アニメーション
テンプレート付き)。ローカルで動かせるなら、ローカルで動かしてください。
それで失うものはありません。
